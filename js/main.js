...
(function () {
  ...
  const MAPS = {
    ...
    b112: {
      ...
      // 이름 검색은 구글이 못 찾음 → 좌표+라벨로 항상 중앙에 핀 표시
      query: "35.57156,129.18756 (UNIST 제5공학관)",
      open: "35.57156,129.18756",
    ...
    b106: {
      ...
      // 이름 검색은 결과가 2개라 핀이 가장자리로 밀림 → 좌표+라벨로 중앙 고정
      query: "35.57219,129.18953 (UNIST 제3공학관)",
      open: "35.57219,129.18953",
